...
public class AppLogistikTervalidasi {
	public static ArrayList<String> pesanan = new ArrayList<String>();
    public static AppLogistikTervalidasi mainApps = new AppLogistikTervalidasi();
    public static final String regex_angka = "[0-9]+";
    public static boolean is_exit = false;
    
    public static void main(String[] args) {
        String[] menus = {"Input Order", "Lacak Order"};
    ...
    private void InputPesanan() {
        ...
        while(!is_exit_input_pesanan) {
            while(i < title_pesanan.length) {
                String values = JOptionPane.showInputDialog(null, "Masukkan " + title_pesanan[i] + ":", "Input " + title_pesanan[i],JOptionPane.INFORMATION_MESSAGE);
    ...
    private void CetakResi() {
        ...
        String list_data = "Berat Paket = " + berat_barang + "gr\n"
                           + "Jarak Lokasi	 = " + jarak_barang + "km\n"
